...
| `STREAM_SCANNER_MAX_BUFFER_MB` | Max per-line buffer (MB) for the stream scanner; `0` means unlimited | `0` |
| `MAX_REQUEST_BODY_MB` | Max request body size (MB, counted **after decompression**); `0` means unlimited | `0` |
