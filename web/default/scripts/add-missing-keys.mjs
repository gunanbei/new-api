...
const newKeys = {
  ...
  fr: {
    ...
    'Current Attempt': 'Tentative actuelle',
    ...
    'Initial Attempt': 'Premiere tentative',
    ...
    'Retry Attempts': 'Tentatives de relance',
  ...
  ru: {
    ...
    'Current Attempt': 'Текущая попытка',
    ...
    'Initial Attempt': 'Первоначальная попытка',
  ...
  vi: {
    ...
    'Current Attempt': 'Lan thu hien tai',
    ...
    'Initial Attempt': 'Lan thu dau tien',
    ...
    'Retry Attempts': 'Cac lan thu lai',
    ...
    'Unknown Channel': 'Kenh khong xac dinh',
    'Attempts': 'So lan thu',
