...
const defaultOperationsSettings: OperationsSettings = {
  ...
  InflightTaskTraceMaxResponseBytes: 0,
  InflightTaskTraceStorageMode: 'memory',
  InflightTaskTraceArchiveChannelID: 0,
  InflightTaskTraceArchiveThresholdBytes: 10485760,
  InflightTaskTraceArchiveRetentionYears: 0,
  InflightTaskTraceArchiveRetentionMonths: 0,
  InflightTaskTraceArchiveRetentionDays: 0,
  InflightTaskTraceArchiveRetentionHours: 0,
  'inflight_log_setting.compliance_confirmed': false,
  'inflight_log_setting.compliance_terms_version': '',
  'inflight_log_setting.compliance_confirmed_at': 0,
  'inflight_log_setting.compliance_confirmed_by': 0,
